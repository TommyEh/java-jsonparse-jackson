...
public class Parse {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            JsonNode rootNode = objectMapper.readTree(new File("weather.json"));

            // TODO : get the value of "name" attribute
            String cityName = rootNode.get("name").asText();

            // TODO : get the "lat" and "lon" values of the "coord"
            Double cityLatitude = rootNode.get("coord").get("lat").asDouble();
            Double cityLongitude = rootNode.get("coord").get("lon").asDouble();

            // TODO : get the "wind" attribute as an Wind object
            Wind wind = objectMapper.treeToValue(rootNode.get("wind"), Wind.class);

            // TODO : get the "weather" attribute as an array of Weather objects
            Weather[] weathers = objectMapper.treeToValue(rootNode.get("weather"), Weather[].class);
